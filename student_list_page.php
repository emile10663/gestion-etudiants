...
<body>
  ...
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">UCAO-UUT</a>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          ...
          <div class="row">
          <div class="col-4">
            <div class="card bg-info shadow-ld link-opacity-10-hover ">
              <div class="card-body py-4 mb-5">
                <h3 class="card-title">Effectif Total</h3>
          ...
          <div class="col-4 bg-transparent">
            <div class="card   shadow-lg bg-info">
              <div class="card-body py-4 mb-5">
                <h3 class="card-title">Nombre de Groupe</h3>
                <p class="card-text">Text</p>
              </div>
            </div>
          </div>
